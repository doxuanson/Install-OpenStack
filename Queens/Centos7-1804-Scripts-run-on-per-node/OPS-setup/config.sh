...
COM_MGNT_IF[1]=eth2
COM_DATAVM_IP[1]=10.10.20.71
COM_DATAVM_NETMASK[1]=255.255.255.0
COM_DATAVM_IF[1]=eth3
...
COM_MGNT_IF[2]=eth2
COM_DATAVM_IP[2]=10.10.20.72
COM_DATAVM_NETMASK[2]=255.255.255.0
COM_DATAVM_IF[2]=eth3
...
BLK_MGNT_IF[1]=eth2
BLK_DATAVM_IP[1]=10.10.20.81
BLK_DATAVM_NETMASK[1]=255.255.255.0
BLK_DATAVM_IF[1]=eth3
...
BLK_MGNT_IF[2]=eth2
BLK_DATAVM_IP[2]=10.10.20.82
BLK_DATAVM_NETMASK[2]=255.255.255.0
BLK_DATAVM_IF[2]=eth3
