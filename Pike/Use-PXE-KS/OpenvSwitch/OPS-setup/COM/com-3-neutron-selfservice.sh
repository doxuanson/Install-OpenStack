...
neutron_config_ovs () {
	...
	ops_add $ovsfile ovs local_ip ${COM_MGNT_IP[$COM_NUM]}
...
neutron_config_relation () {
	...
	ifconfig br-provider ${COM_EXT_IP[$COM_NUM]} netmask ${COM_EXT_NETMASK[$COM_NUM]}
...
iface br-provider inet static
    ...
    dns-nameservers 8.8.8.8
    ovs_type OVSBridge
    ovs_ports ${COM_EXT_IF[$COM_NUM]}

allow-br-provider ${COM_EXT_IF[$COM_NUM]}
iface ${COM_EXT_IF[$COM_NUM]} inet manual
